...
//if it is, set the phrase variable created above to
// 'I love code', it it's not true set the phrase variable to 
//'I do not love to code'

const doYouLoveCode = (lovesCode) => {
    return (lovesCode ? `I love code` : `I do not love to code`);
}
phrase = doYouLoveCode(lovesCode);
